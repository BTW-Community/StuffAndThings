...
public class YYBlockTotemCarving extends YYBlockTotemBase
{
	...
	{
		return models[renderer.blockAccess.getBlockMetadata(i, j, k)&7].RenderAsBlock(renderer, this, i, j, k);
	}
	...
	{
		sideBarkIcon = register.registerIcon("yyBlockTotemCarving_start");
		carveIcon = register.registerIcon("yyBlockTotemCarving");
		topIcon = register.registerIcon("yyBlockTotemCarving_start_top");
	}
	...
	{
		AxisAlignedBB temp = aabbs[world.getBlockMetadata(x, y, z)&7].MakeTemporaryCopy();
