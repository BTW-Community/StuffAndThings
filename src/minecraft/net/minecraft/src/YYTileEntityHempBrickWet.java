...
public class YYTileEntityHempBrickWet extends FCTileEntityUnfiredBrick
{
	...
	public void UpdateCooking()
	{
		...
		YYBlockHempBrickWet brickBlock = YYStuffAndThings.yyBlockHempBrickWet;
		
		if ( m_bIsCooking )
		{
			m_iCookCounter++;
			
			if ( m_iCookCounter >= m_iTimeToCook*2 )
			{
	...
	protected int ComputeCookLevel()
	{
		if ( m_iCookCounter > 0 )
		{
			int iCookLevel= (int)( ( (float)m_iCookCounter / (float)(m_iTimeToCook*2) ) * 7F ) + 1;
