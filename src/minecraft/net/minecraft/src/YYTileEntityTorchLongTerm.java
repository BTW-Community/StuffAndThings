...
public class YYTileEntityTorchLongTerm extends TileEntity
{
    private static final float m_fChanceOfFireSpread = 0.01F;
    private static final float m_fChanceOfGoingOutFromRain = 0.01F;
    public static final int m_iMaxBurnTime = 240000;
    public static final int m_iSputterTime = 6000;
    public int m_iBurnTimeCountdown = 0;

    public YYTileEntityTorchLongTerm()
    {
        this.m_iBurnTimeCountdown = 240000;
    }
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if (this.m_iBurnTimeCountdown > 0 && (this.worldObj.rand.nextFloat() > 0.01F || !this.IsRainingOnTorch()))
            {
                if (this.m_iBurnTimeCountdown < 6000)
                {
                    ...
                    if (!YYBlockTorchLongTermBurning.GetIsSputtering(var1))
                    {
                    	YYBlockTorchLongTermBurning var2 = (YYBlockTorchLongTermBurning)((YYBlockTorchLongTermBurning)Block.blocksList[this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord)]);
    ...
    {
    	YYBlockTorchLongTermBurning var1 = (YYBlockTorchLongTermBurning)((YYBlockTorchLongTermBurning)Block.blocksList[this.worldObj.getBlockId(this.xCoord, this.yCoord, this.zCoord)]);
    ...
    private void ExtinguishTorch()
    {
        ...
        var3 = YYBlockTorchLongTermUnlit.SetIsBurnedOut(var3, true);
