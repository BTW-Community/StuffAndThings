...
public class YYItemBlockTorchLongTermBurning extends FCItemBlockTorchBurning
{
    private static final float m_fChanceOfGoingOutFromRain = 0.0025F;
    public static final int m_iMaxDamage = 32;
    public static final float m_fDamageToBurnTimeRatio = 0.00013333333F;
    public static final int m_iSputterDamage = 32;
    private Icon m_iconSputtering;

    public YYItemBlockTorchLongTermBurning(int var1)
    {
        super(var1);
        this.maxStackSize = 1;
