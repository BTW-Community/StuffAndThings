...
public class FCBetterThanWolves extends FCAddOn
{
    ...
    public static void ServerPlayerConnectionInitialized(NetServerHandler var0, EntityPlayerMP var1)
    {
        ...
        {
            FCUtilsWorld.SendPacketToPlayer(var0, new Packet3Chat("\u00a7e" + var1.username + " connected to Better Than Wolves server V" + "4.B0000003"));
            var2 = new ByteArrayOutputStream();
            var3 = new DataOutputStream(var2);

            try
            {
                var3.writeUTF("4.B0000003");
            }
        ...
        {
            FCUtilsWorld.SendPacketToPlayer(var0, new Packet3Chat("\u00a7f" + "BTW V" + "4.B0000003"));
        }
    ...
    public GuiContainer ClientGetAssociatedGUI(EntityClientPlayerMP var1, int var2)
    {
        if (var2 != fcMillStoneContainerID)
        {
            ...
            if (var2 == YYBaitMod.yyLargeBasketContainerID)
        	{
        	    InventoryBasic var3 = new InventoryBasic("container.yyLargeBasket", false, 12);
        	    return new YYClientGuiLargeBasket(var1.inventory, var3);
        	}
        }
    ...
    public boolean ClientPlayCustomAuxFX(Minecraft var1, World var2, EntityPlayer var3, int var4, int var5, int var6, int var7, int var8)
    {
        ...
        switch (var4)
        {
            ...
            case 2285:
                var2.playSound(var10, var12, var14, "random.burp", 0.25F, var9.nextFloat() * 0.3F + 1.0F);
                break;
