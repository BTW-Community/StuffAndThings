...
public class YYTileEntityLargeBasket extends FCTileEntityBasket implements IInventory
{
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            if ((this.m_iFullUpdateCounter + this.xCoord + this.yCoord + this.zCoord) % 200 == 0 && this.m_iNumUsingPlayers != 0)
            {
                ...
                while (var2.hasNext())
                {
                    ...
                    if (var3.openContainer instanceof YYContainerLargeBasket && ((YYContainerLargeBasket)var3.openContainer).m_containerInventory == this)
                    {
