...
public class YYBlockLargeBasket extends FCBlockBasket
{
    ...
    public void registerIcons(IconRegister var1)
    {
        ...
        this.m_iconBaseOpenTop = var1.registerIcon("yyBlockLargeBasket_open_top");
        this.m_iconFront = var1.registerIcon("yyBlockLargeBasket_front");
        this.m_iconTop = var1.registerIcon("yyBlockLargeBasket_top");
        this.m_iconBottom = var1.registerIcon("yyBlockLargeBasket_bottom");
    }
