...
public class FCEntitySpider extends EntitySpider
{
	...
	public void initCreature()
	{
		...
		{
			FCEntitySkeleton jockey = (FCEntitySkeleton) EntityList.createEntityOfType(FCEntitySkeleton.class, worldObj);            
	...
	private void SpitWeb( Entity targetEntity )
	{
		...
		{
			worldObj.spawnEntityInWorld( EntityList.createEntityOfType(FCEntitySpiderWeb.class, worldObj, this, targetEntity ) );
