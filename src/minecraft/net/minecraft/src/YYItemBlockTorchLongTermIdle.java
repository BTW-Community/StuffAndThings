...
public class YYItemBlockTorchLongTermIdle extends FCItemBlockTorchIdle
{
    public YYItemBlockTorchLongTermIdle(int var1)
    {
        super(var1);
        this.setUnlocalizedName("yyBlockTorchLongTermIdle");
    }
    ...
    protected ItemStack OnRightClickOnIgniter(ItemStack var1, World var2, EntityPlayer var3)
    {
        ...
        ItemStack var7 = new ItemStack(YYBaitMod.yyBlockTorchLongTermBurning, 1, 0);
        long var8 = FCUtilsWorld.GetOverworldTimeServerOnly() + 240000L;
