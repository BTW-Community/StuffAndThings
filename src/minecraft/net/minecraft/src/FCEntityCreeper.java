...
public class FCEntityCreeper extends EntityCreeper
{
	...
	public boolean interact( EntityPlayer player )
	{
		...
		if ( playersCurrentItem != null && playersCurrentItem.getItem() instanceof FCItemShears && GetNeuteredState() == 0 )
		{
	...
	protected void dropRareDrop(int p)
	{
		if(YYStuffAndThings.yyCreeperFire)
		{
			this.dropItem(FCBetterThanWolves.fcItemHellfireDust.itemID, 1);
		}
	}
