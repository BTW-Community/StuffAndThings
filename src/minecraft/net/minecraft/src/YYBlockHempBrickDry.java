...
public class YYBlockHempBrickDry extends BlockContainer
{
    ...
    public YYBlockHempBrickDry(int var1)
    {
        ...
        this.setUnlocalizedName("yyBlockBrickHempDry");
    }
    ...
    {
        return YYBaitMod.yyItemHempBrickWet.itemID;
    }
    ...
    public void OnFinishedCooking(World var1, int var2, int var3, int var4)
    {
        ...
        var1.setBlockAndMetadataWithNotify(var2, var3, var4, YYBaitMod.yyBlockHempBrickWet.blockID, var5);
    }
    ...
    {
        return var5 == 0 ? FCClientUtilsRender.ShouldRenderNeighborFullFaceSide(var1, var2, var3, var4, var5) : true;
    }
