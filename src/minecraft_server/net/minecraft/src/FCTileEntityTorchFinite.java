...
{
	static protected final float m_fChanceOfFireSpread = 0.01F;
	static protected final float m_fChanceOfGoingOutFromRain = 0.01F;
	...
	protected boolean IsRainingOnTorch()
	{
		FCBlockTorchFiniteBurning block = (FCBlockTorchFiniteBurning)(Block.blocksList[worldObj.getBlockId( xCoord, yCoord, zCoord )]);
	...
	protected void ExtinguishTorch()
	{
		m_iBurnTimeCountdown = 0;
