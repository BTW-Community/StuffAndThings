...
public class YYBlockTorchLongTermUnlit extends FCBlockTorchBaseUnlit
{
    private Icon m_burnedIcon;

    protected YYBlockTorchLongTermUnlit(int var1)
    {
        super(var1);
    ...
    {
        return YYBaitMod.yyBlockTorchLongTermBurning.blockID;
    }
